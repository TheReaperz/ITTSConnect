...
import { Box, Stack, Center, Text, HStack, Badge, Avatar } from 'native-base';

const JobsCardCompany = ({ job, navigation, onLongPress }) => {
    ...
    return (
        <View>
            <TouchableOpacity onLongPress={() => onLongPress(job)}>
